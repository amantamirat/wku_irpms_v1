...
import stageRoutes2 from './modules/projects/stages/stage.routes';
import reviewerRoutes from './modules/projects/reviewers/reviewer.routes';
import resultRoutes from './modules/projects/results/result.routes';
