...
const SaveConstraint = ({
    ...
    const updateRangeField = (
        ...
        setLocalConstraint((prev) => {
            ...
            // Remove range property if both bounds are cleared
            if (
    ...
    return (
        <>
            ...
            <Dialog
                ...
                header={
                    localConstraint._id
                        ? 'Edit Constraint Profile'
                        : 'Define New Constraint Profile'
                }
                modal
                maximizable
                className="p-fluid"
            ...
            >
                ...
                <h5 className="mb-3 text-700 border-bottom-1 surface-border pb-2">
                    Constraint Ranges
                </h5>
